...
shinyUI(fluidPage(
  ...
  tags$h2(tags$a(href="http://www.fujitsu.com", "Create a US tour for Sam to go on and optimise it!", target="_blank")),
  ...
  fluidRow(
    ...
    column(2,
      ...
      inputPanel(
        numericInput("total_iterations", "Number of Iterations to Run", 100000, min=0, max=1000000, width="80%"),
